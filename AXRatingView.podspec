Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   - Support Auto Layout
                   DESC
  s.homepage     = "https://github.com/jokerping/AXRatingView"
  ...
  s.author       = { "akiroom" => "410236056@qq.com" }
  s.platform     = :ios
  s.source       = { :git => "https://github.com/jokerping/AXRatingView", :tag => s.version.to_s }
